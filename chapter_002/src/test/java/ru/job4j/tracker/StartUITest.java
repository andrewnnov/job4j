...
public class StartUITest {
    ...
    public void whenUserAddItemThenTrackerHasNewItemWithSameName() {
        Input input = new StubInput(new String[]{"0", "test1", "desk1", "y"});
    ...
    public void whenUpdateThenTrackerHasUpdateValue() {
        ...
        tracker.add(item);
        Input input = new StubInput(new String[] {"2", item.getId(), "test99", "desc99", "y"});
        new StartUI(input, tracker).init();
    ...
    public void whenFindItemByIdTrackerHasNotThisItem() {
        ...
        Input input = new StubInput(new String[] {"4", idNotInTracker, "y"});
        new StartUI(input, tracker).init();
...
//    }
    ...
    public void whenUserChooseShowAllItem() {
        ...
        StringBuilder showAllItem = new StringBuilder()
                ...
                .append("Exit?(y): ").append(System.lineSeparator());


        assertThat(new String(out.toByteArray()), is(MENU.toString() + showAllItem.toString()));   }
    ...
    public void whenUserChooseEditItem() {
        Item item = new Item("name1", "desc1");
        tracker.add(item);
        Input input = new StubInput(new String[]{"2", item.getId(), "name2", "desc2", "y"});
        new StartUI(input, tracker).init();
        ...
        assertThat(new String(out.toByteArray()), is(MENU.toString() + editItem.toString()));
    }
    ...
    public void whenUserChooseDeleteItem() {
        ...
        assertThat(new String(out.toByteArray()), is(MENU.toString() + deleteItem.toString()));
    }
    ...
    public void whenUserChooseFindItemById() {
        ...
        assertThat(new String(out.toByteArray()), is(MENU.toString() + findItemById.toString()));
    }
